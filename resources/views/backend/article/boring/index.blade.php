...
@section('nav')
    <ul class="nav nav-tabs nav-stacked mx-lg-5 my-2">
        ...
        <li class="nav-item">
            <a href="/admin/article/boring" class="nav-link active">无聊图</a>
        </li>
        <li class="nav-item">
...
@section('content')
            ...
            <form class="form border border-info rounded " action="/admin/article/boring" method="POST">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="border border-info rounded m-2 p-2">
                        ...
                        <div class="form-group">
                            <label for="">图片</label>
                            <input type="file"  class="form-control-file" id="picture"  required="required">
                            <button type="button" class="btn btn-primary" onclick="upload()">上传预览图</button>
    ...
    <script>
       function upload()
        {
            var data=$("#picture")[0].files[0];
            let formdata=new FormData();
            formdata.append('picture',data);
            axios.post(
                '/admin/upartpic',formdata,
                {
                    headers:{
